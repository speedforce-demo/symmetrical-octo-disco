...
auth_email="speedforce.demo@gmail.com"                                       # The email used to login 'https://dash.cloudflare.com'
auth_method="global"                                 # Set to "global" for Global API Key or "token" for Scoped API Token
auth_key="7e963b2c4de50c5eb15c3a885d6c11f8af4a4"                                         # Your API Token or Global API Key
zone_identifier="708e0db8d80bd60a3f59fd38143052d1"                                  # Can be found in the "Overview" tab of your domain
record_name=".xui.speedforce.us.eu.org"                                      # Which record you want to be synced
